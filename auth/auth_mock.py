...
<style>
  ...
  .lg-icon-box {
    ...
    background: linear-gradient(145deg, #E8ECF7 0%, #DDE3F2 50%, #E8ECF7 100%);
    border-radius: 24px;
  ...
  .lg-app-name {
    ...
    background: linear-gradient(135deg, #0F172A 0%, #4F46E5 40%, #0891B2 80%, #4F46E5 100%);
  ...
  [data-testid="stForm"] {
    ...
    background: linear-gradient(160deg, #FFFFFF 0%, #FFFFFF 100%) !important;
  ...
  .lg-divider {
    ...
    margin: 22px 0 14px;
    font-family: 'JetBrains Mono', monospace;
    font-size: 0.6rem; color: #E2E6F0; letter-spacing: 2px; text-transform: uppercase;
  ...
  .lg-pill {
    ...
    font-family: 'JetBrains Mono', monospace;
    font-size: 0.63rem; color: #64748B; cursor: default;
    transition: border-color 0.2s, background 0.2s;
  }
  .lg-pill:hover { border-color: rgba(99,102,241,0.4); background: rgba(99,102,241,0.12); color: #64748B; }
  .lg-pill-dot {
  ...
  .lg-notice {
    ...
    margin-top: 22px;
    font-size: 0.7rem; color: #92400E; line-height: 1.65;
  ...
  ::-webkit-scrollbar-thumb { background: #E5E9F2; border-radius: 4px; }
...
""", unsafe_allow_html=True)
    ...
    if not _HIDE_DEMO_CREDS and _USERS is _DEMO_USERS:
        ...
        st.markdown(
            ...
            f'<div style="text-align:center;font-size:0.6rem;color:#64748B;'
